...
Do you even need images when you can write that well? Geez!

For my new thumbnail, I wanted an image that had my initials, a data analytics theme, and maybe the space needle as a tribute to my beloved city of Seattle. After my first two prompts, I wanted to combine elements of the first two images. "Take the background from the first image and add the space needle from the second image". Fail. It just gave me another image of the space needle. 
But later, it did "remember" the image it had just generated and tweaked it for me: "same image but with some more data lines, blueprint-y, and RB initials at the bottom like a signature." Only five prompts and I got a winner - its missing the initials I asked for, but I'm happy with it:
